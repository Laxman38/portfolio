        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-2">
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:laxman.sg17@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    laxman.sg17@gmail.com
                  </a>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-y-4 justify-center gap-2">
                <a
                  href="https://www.linkedin.com/in/laxman-singh-b97705254"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/laxman__singh07"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Instagram />
